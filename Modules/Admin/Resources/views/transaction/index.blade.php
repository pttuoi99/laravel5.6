                ...
                @foreach($transactions as $transaction)
                    <tr>
                        ...
                        <td>
                            ...
                            <a style="padding: 5px 10px; border: 1px solid #eee; font-size: 12px;" data-id="{{ $transaction->id }}" class="js_order_item" href="{{ route('admin.get.view.order',$transaction->id) }}"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
