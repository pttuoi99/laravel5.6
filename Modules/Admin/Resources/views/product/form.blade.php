    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <div class="form-group">
                ...
                <textarea name="pro_description" class="form-control" cols="30" rows="3" placeholder="mô tả ngắn sản phẩm">{{ old('pro_description',isset($product->pro_description) ? $product->pro_description : '') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Meta Descriotion" value="{{ old('pro_title_seo',isset($product->pro_title_seo) ? $product->pro_title_seo : '') }}" name="pro_title_seo">
            </div>
            <div class="form-group">
                <label for="pro_description_seo">Meta Description:</label>
                <input type="text" class="form-control" placeholder="Meta Descriotion" value="{{ old('pro_description_seo',isset($product->pro_description_seo) ? $product->c_description_seo : '') }}" name="pro_description_seo">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
            ...
            <div class="form-group">
                <img id="out_img" src="{{ asset('images/no-image.png') }}" alt="" style="height: 300px; width: 100%">
            </div>
            <div class="form-group">
