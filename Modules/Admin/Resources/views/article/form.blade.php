    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Meta Descriotion" value="{{ old('a_title_seo',isset($article->a_title_seo) ? $article->a_title_seo : '') }}" name="a_title_seo">
            </div>
            <div class="form-group">
                <label for="a_description_seo">Meta Description:</label>
                <input type="text" class="form-control" placeholder="Meta Descriotion" value="{{ old('a_description_seo',isset($article->a_description_seo) ? $article->c_description_seo : '') }}" name="a_description_seo">
            </div>
            <div class="form-group">
