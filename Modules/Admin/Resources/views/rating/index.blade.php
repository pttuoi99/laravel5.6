                ...
                @if(isset($ratings))
                    @foreach($ratings as $rating)
                        <tr>
                            ...
                            <td>
                                <a style="padding: 5px 10px; border: 1px solid #eee; font-size: 12px;" href="<!-- {{ route('admin.get.action.product',['delete',$rating->id]) }} -->"><i class="fas fa-trash-alt" style="font-size: 11px;"></i>Xóa</a>
                            </td>
                        </tr>
                    @endforeach
                @endif
