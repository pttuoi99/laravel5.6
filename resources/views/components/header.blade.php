                ...
                <div class="mainmenu">
                    <nav>
                        <ul>
                            ...
                            <li class="expand"><a href="index.html">Sản phẩm</a>
                            ...
                            <li class="expand"><a href="{{ route('get.list.acticle') }}" title="Tin tức">Tin tức</a></li>
                    ...
                    <div class="disflow">
                        <div class="expand dropps-menu">
                            ...
                            <ul class="restrain language" style="width: 200px;">
                                @if(Auth::check())
                                <li><a href="{{ route('user.dashboard') }}" title="tổng quan">Quản lý</a></li>
