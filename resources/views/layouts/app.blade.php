...
<head>
    ...
    <title>Điện máy | @yield('title')</title>
...
<p>Tài khoản của bạn chưa được kích hoạt. Hãy check địa chỉ email để kích hoạt tài khoản</p>
@endif
@include('components.header')
    ...
    @if(\Session::has('warning'))
        <div class="alert alert-warning alert-dismissible thongbao">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
