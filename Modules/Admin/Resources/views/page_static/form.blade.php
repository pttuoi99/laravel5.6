    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                ...
                <textarea name="ps_content" required="" class="form-control" id="ps_content" cols="30" rows="3" placeholder="nội dung">{{ old('ps_content',isset($page->ps_content) ? $page->ps_content : '') }}</textarea>
            </div>
